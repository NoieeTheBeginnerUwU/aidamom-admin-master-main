        ...
        <table>
          <tr>
            <td colspan="3" className="normal">
              <div>
                <label> NAME : </label>
                <input type="text" id="name" className="long"  style={{ width: '45%' }}  class="centered-input" />
                <label>AGE:</label>
                <input type="number" className="short" class="centered-input"  style={{ width: '10%' }} />
                <label> STATUS : </label>
              ...
              <div>
                ...
                <input type="text" id="dateadmitted" className="medium"  style={{ width: '27%' }} class="centered-input"  />
                <label> G: </label>
              ...
              <div>
                ...
                <input type="text" id="datedeliverd" class="centered-input" />
                <label> NSD: </label>
                <input type="text" id="nsd"class="centered-input"  />
                <label>BREECH : </label>
          ...
          <tr>
            <td colspan="2">
              ...
              <div  className="short">
                ...
                <input type="text" id="breech" className="short" class="centered-input" />
                <label className="indented" id="indented">
                  NO :{' '}
                </label>
                <input type="text" id="breech" className="short" class="centered-input" />
