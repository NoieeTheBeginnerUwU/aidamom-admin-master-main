            ...
            <Grid container spacing={1} rowSpacing={1}  >
              ...
              <Modal open={openPrenatalVisitReports} onClose={handleClosePrenatalVisitReports}>
                ...
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '80%', height: '90%' , overflow:'scroll' , bgcolor: 'background.paper', boxShadow: 24, p: 4 }}>
                  ...
                  <Button sx={{backgroundColor:activeInner===0?"skyblue":"transparent",color:activeInner===0?"white":"skyblue",padding:'1%'}} onClick={()=> setActiveInner(0)}>Prenatal Report</Button>
                  <Button sx={{backgroundColor:activeInner===1?"skyblue":"transparent",color:activeInner===1?"white":"skyblue",padding:'1%'}} onClick={()=> setActiveInner(1)}>Patient Data Form</Button>
                  <Button sx={{backgroundColor:activeInner===2?"skyblue":"transparent",color:activeInner===2?"white":"skyblue",padding:'1%'}} onClick={()=> setActiveInner(2)}>Consent Form</Button>
                  {/**---------------------------------- Forms---------------------------------- */}
                  {
                    activeInner===0&&
                    <div style={{ width: '100%', }}>
